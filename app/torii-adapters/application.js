...
export default Ember.Object.extend({
   ...
   */
    ...
    let userData = store.find('role', 1).then(role => {
   ...
   */
    ...
    if (userData.cachedUserProfile) {
      userProfile = userData.cachedUserProfile;
    }
    ...
    return {
      ...
      link: userProfile.link || null,
      locale: userProfile.locale || null,
      picture: userData.profileImageURL || null,
